...
**Read `docs/BUILD-ORDER.md` first for what to build next. The 9 docs in `docs/blueprints/` are the authoritative specs** — each contains full per-playbook dissection, the consolidated tool specs, safety mechanics, and cross-suite wiring. Do not re-derive decisions already made there.
