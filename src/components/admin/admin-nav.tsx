...
const TABS = [
  ...
  { href: "/dashboard/admin/valuations", label: "Home values" },
  { href: "/dashboard/admin/matches", label: "Agent match" },
  { href: "/dashboard/admin/assignment-values", label: "Assignments" },
