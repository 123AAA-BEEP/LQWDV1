...
const SELECT =
  "project_id, slug, project_name, builder_name, city, neighbourhood, province, project_type, sales_status, construction_status, price_from_public, price_to_public, hero_image_url, published_at";
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {projects.map((p) => {
              ...
              const location = [p.neighbourhood, p.city, p.province]
                ...
                .join(", ");
              return (
                <Link key={p.project_id} href={`/projects/${p.slug}`}>
